...
- (void)setupDefaultColorStates {
    ...
    if ([self respondsToSelector:@selector(tintColor)]) {
        ...
        // iOS 6
        defaultActiveColor = [UIColor colorWithRed:0.76 green:0.76 blue:0.77 alpha:1.0];// sandeep
    }
...
- (void)drawRect:(CGRect)aRect
{
    ...
    if (self.shouldDrawPlaceholder) {
        ...
        UIColor *placeholderGray = self.defaultPlaceholderColor ?: [UIColor colorWithRed:195/255.f green:195/255.f blue:197/255.f alpha:1.f];
        
       // UIColor *placeholderGray = self.defaultPlaceholderColor ?: [UIColor blackColor];
