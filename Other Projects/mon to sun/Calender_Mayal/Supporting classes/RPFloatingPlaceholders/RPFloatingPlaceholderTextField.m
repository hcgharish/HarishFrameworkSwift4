...
- (void)setPlaceholder:(NSString *)aPlaceholder
{
    ...
    if (self.cachedPlaceholder != nil) { //to change color of placeholder
        self.attributedPlaceholder = [[NSAttributedString alloc] initWithString: self.cachedPlaceholder attributes:@{NSForegroundColorAttributeName: [UIColor darkGrayColor]}];
    }
...
- (void)setupViewDefaults
{
    ...
    self.floatingLabel.font = [UIFont boldSystemFontOfSize:13.f];
...
- (void)setupDefaultColorStates {
    ...
    if ([self respondsToSelector:@selector(tintColor)]) {
        ...
        //[UIColor colorWithRed:0.26 green:0.79 blue:0.96 alpha:1.0];
        defaultActiveColor = [UIColor colorWithRed:1.13 green:0.28 blue:0.28 alpha:1.0];//sandeep
        //defaultActiveColor = [UIColor colorWithRed:0.26 green:0.79 blue:0.96 alpha:1.0];
    }
...
//    self.floatingLabelInactiveTextColor = self.floatingLabelInactiveTextColor ?: [UIColor colorWithWhite:0.7f alpha:1.f];
    self.floatingLabelInactiveTextColor = self.floatingLabelInactiveTextColor ?:  [UIColor colorWithRed:0.76 green:0.76 blue:0.77 alpha:1.0];;//sandeep
...
- (void)drawRect:(CGRect)aRect
{
    ...
    if (self.shouldDrawPlaceholder) {
        UIColor *placeholderGray = self.defaultPlaceholderColor ?: [UIColor colorWithRed:0.76 green:0.76 blue:0.77 alpha:1.0];
...
- (void)adjustFramesForNewPlaceholder
{
    ...
    self.floatingLabel.textAlignment = NSTextAlignmentLeft;
    
    self.originalFloatingLabelFrame = CGRectMake(self.originalTextFieldFrame.origin.x + 0.5, self.originalTextFieldFrame.origin.y ,
...
- (void)textFieldDidBeginEditing:(NSNotification *)notification
{
    ...
    [self animateFloatingLabelColorChangeWithAnimationBlock:^{
        ...
        _floatingLabel.textColor = [UIColor colorWithRed:1.13 green:0.28 blue:0.28 alpha:1.0];//sandeep
    }];
}
